...
class potsdam(torch.utils.data.Dataset):
...
if __name__ == '__main__':
    ...
    data = potsdam(['/data/sqy/potsdam/train', '/data/sqy/potsdam/val'],
                  ['/data/sqy/potsdam/train_labels', '/data/sqy/potsdam/val_labels'], '/data/sqy/potsdam/class_dict.csv',
